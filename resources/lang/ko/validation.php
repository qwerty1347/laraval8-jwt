...
return [
    ...
    */
    ...
    'prohibited_unless' => ':attribute 필드는 :other가 :values 중 하나일 때 금지되지 않습니다.',
    'prohibits' => ':attribute 필드는 :other가 존재하는 것을 금지합니다.',
    'regex' => ':attribute 형식이 유효하지 않습니다.',
    'required' => ':attribute 필드는 필수입니다.',
    'required_array_keys' => ':attribute 필드는 다음 항목의 입력을 포함해야 합니다: :values.',
    'required_if' => ':attribute 필드는 :other가 :value일 때 필수입니다.',
    'required_unless' => ':attribute 필드는 :other가 :values 중 하나가 아닐 때 필수입니다.',
    'required_with' => ':attribute 필드는 :values가 있을 때 필수입니다.',
    'required_with_all' => ':attribute 필드는 :values가 있을 때 필수입니다.',
    'required_without' => ':attribute 필드는 :values가 없을 때 필수입니다.',
    'required_without_all' => ':attribute 필드는 :values가 없을 때 필수입니다.',
